 ...
 * for tables to describe sequences
 *
 ...
 * for tables to describe sequences
 *
 * From an abstract perspective, each ADC module(ADC0 and ADC1)
 ...
 *
 *      You can also implement there to be no wait, in which case the function
